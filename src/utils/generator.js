...
// ----------------- Generator -----------------
export function generateCodeFromFormData(rawBody) {
    ...
    // const visibility = groups.visibility || {}; // Used in buildArgsPhp
    // const query = groups.query || {}; // Used in buildArgsPhp
    // const permalinks = groups.permalinks || {}; // Used in buildArgsPhp
    // const capabilities = groups.capabilities || {}; // Used in buildArgsPhp
    // const rest = groups.rest || {}; // Used in buildArgsPhp
    // const other = groups.other || {}; // Used in buildArgsPhp
...
export const defaultData = {
    ...
    taxonomy: { singular: 'Taxonomy', plural: 'Taxonomies', post_types: 'post', hierarchical: 'no' },
    labels: {},
    visibility: {},
    query: {},
    permalinks: {},
